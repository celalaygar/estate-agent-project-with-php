...
?>		
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Musteri Düzenleme</h2>
						<div class="col-md-8">
							<div class="panel panel-default">
								<div class="panel-heading">Form fields</div>
								<div class="panel-body">
									<form method="post" action="<?=base_url()?>admin/home/musteriler_guncellekaydet/<?=$veri[0]->id?>" class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input class="form-control" value="<?=$veri[0]->email?>" name="email" placeholder="Adınız Soyadınız" type="text">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input class="form-control" value="<?=$veri[0]->telefon?>" name="telefon" placeholder="Adınız Soyadınız" type="text">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 control-label">Adres</label>
											<div class="col-sm-10">
												<input class="form-control" value="<?=$veri[0]->adres?>" name="adres" placeholder="Adınız Soyadınız" type="text">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 control-label">il</label>
											<div class="col-sm-10">
												<input class="form-control" value="<?=$veri[0]->il?>" name="il" placeholder="Adınız Soyadınız" type="text">
											</div>
										</div>
										<div class="form-group">
